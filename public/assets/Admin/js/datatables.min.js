...
!(function (n) {
                  ...
                  this.each(function () {
                      ...
                      if ("table" != this.nodeName.toLowerCase())
                          ...
                          if (t.aoColumns) h = t.aoColumns;
                              ...
                              for (O = n[(e = 0)].length; e < O; e++)
                                  h.push(null);
                          for (e = 0, O = h.length; e < O; e++) tt(c);
                          var g,
                              m,
                              v,
                              b,
                          ...
                          if (T)
                              for (g = 0, m = T.length; g < m; g++) C(g, T[g]);
                          var F,
                          ...
                          if (
                              ...
                              for (
                                  var j = c.aaSorting, e = 0, O = j.length;
                                  e < O;
                                  e++
                              )
    ...
    function nt(t) {
        ...
        i = t.oScroll;
        ("" === i.sY && "" === i.sX) || Bt(t), G(t, null, "column-sizing", [t]);
    }
    function at(t, e) {
        t = it(t, "bVisible");
    ...
    function yt(t, e, n, a) {
        function r(t, e) {
            ...
            "string" == typeof t &&
                -1 !== (n = t.indexOf("@")) &&
                ((n = t.substring(n + 1)), m(t)(a, e.getAttribute(n)));
        }
        function o(t) {
            (void 0 !== n && n !== d) ||
                ((l = f[d]),
        ...
        return (
            e && (e = e.getAttribute("id")) && m(t.rowId)(a, e),
            { data: a, cells: u }
        );
    }
    function Dt(t, e) {
        ...
        if (!n.displayData) {
            ...
            for (var r = 0, o = a.length; r < o; r++)
                n.displayData.push(B(t, e, r, "display"));
        }
    ...
    function It(e) {
        ...
        if (((e.nTableWrapper = r[0]), e.sDom))
            ...
            n.forEach(function (t) {
                ...
                g(e, r, { full: { table: !0, contents: [qt(e)] } }),
                t.forEach(function (t) {
                    g(e, r, t);
                });
        }
    ...
    function Mt(o) {
        ...
        o.bInitialised
            ? (wt(o, "header"),
              ...
              (n = function () {
                  if (s.aaData)
                      for (i = 0; i < s.aaData.length; i++) D(o, s.aaData[i]);
                  else (!u && "dom" != c) || ft(o, H(o.nTBody).children("tr"));
                  (o.aiDisplay = o.aiDisplayMaster.slice()), It(o);
                  var t = o,
                      e = t.nTHead,
                  ...
                  !0 === a ? (e = n[0]) : !1 === a && (e = n[n.length - 1]),
                      ...
                      Ut(o),
                      w(o, !0),
                      G(o, null, "preInit", [o], !0),
                      d(o),
                      ("ssp" == c && !u) ||
                          ("ajax" == c
                              ? Ft(o, {}, function (t) {
                                    var e = Nt(o, t);
                                    for (i = 0; i < e.length; i++) D(o, e[i]);
                                    (o.iInitDisplayStart = l),
                                        d(o),
                                        w(o, !1),
                                        Ht(o);
                                })
    ...
    function Bt(e) {
        ...
        if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis)
            ...
            if (
                ...
                c && (m = c.clone().prependTo(u)).find("[id]").removeAttr("id"),
                e.aiDisplay.length)
            )
                for (
                    var h = u
            ...
            var s =
                ...
                m = u.outerWidth();
            a.css("width", I(m)),
                n.css("width", I(m)).css(f, s ? t + "px" : "0px"),
                c &&
                    (l.css("width", I(m)),
                    i.css("width", I(m)).css(f, s ? t + "px" : "0px")),
    ...
    function Jt(t, e, n) {
        ...
        for (
            ...
            y && (h = y.call(m.oInstance, m, v, rt(m, v)));
            for (
                var D = V.ext.type.order[b.sType + "-pre"], x = m.aoData, S = 0;
                S < x.length;
                S++
            )
                x[S] &&
    ...
    function Zt(t) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (e = 0, n = r.length; e < n; e++)
                (a = r[e].src),
                    H(f(t.aoData, "anCells", a)).removeClass(
                        o + (e < 2 ? e + 1 : 3)
                    );
            for (e = 0, n = i.length; e < n; e++)
                (a = i[e].src),
                    H(f(t.aoData, "anCells", a)).addClass(
                        o + (e < 2 ? e + 1 : 3)
                    );
        }
        t.aLastSort = i;
        ...
        if (n.length && t.length) {
            ...
            if (a._details) {
                ...
                var i = n[0],
                    ...
                    l = i.aoData;
                if (
                    (r.off(e + " " + t + " " + a), f(l, "_details").length > 0)
                ) {
                    r.on(e, function (t, e) {
                        if (i !== e) return;
                        r.rows({ page: "current" })
                ...
                var e = this,
                    ...
                    t = this.iterator("column", function (t, e) {
                        ...
                        !(function (t, e, n) {
                            ...
                            else H(f(t.aoData, "anCells", e)).detach();
                ...
                return (
                    ...
                    null == t
                        ...
                        : ((e = m
                          ...
                          (e = m && m.selected ? this.cells(e, m) : e),
                          H.extend(e.selector, { cols: t, rows: g, opts: m }),
                          e)
                );
            }),
        ...
        Ne =
            ...
            V.type("date", {
                ...
                detect: {
                    allOf: function (t) {
                        var e;
                        return !t || t instanceof Date || O.test(t)
            ...
            _: function (d, f, h) {
                ...
                "disable" === f.attr("data-dt-order") ||
                    ...
                    H(d.nTable).on(
                        ...
                        function (t, e) {
                            var n, a, r, o, i, l, s, u, c;
                            d === e &&
                                ((n = h.order),
                                (c = e.api.columns(f)),
                                (a = d.aoColumns[c.flatten()[0]]),
                                (r = c.orderable().includes(!0)),
                                (o = ""),
                                (u = c.indexes()),
                                ...
                                (s =
                                    ...
                                    (i = e.sortDetails)
                                        .filter(function (t) {
                                            return e.aoColumns[t.col].bVisible;
                                        })
                                        .map(function (t) {
                                            return t.col;
                                        })
                                    ...
                                    ","),
                                f
                                    .removeClass(n.isAsc + " " + n.isDesc)
                                    .toggleClass(n.none, !r)
                                    .toggleClass(
                                        n.canAsc,
                                        r && l.includes("asc")
                                    )
            ...
            return n.oFeatures.bFilter
                ? ((t = n.oClasses.search),
                  ...
                  (s = H("<div>")
                      ...
                      .find("label")
                      .attr("for", "dt-search-" + Oe),
                  s.find("input").attr("id", "dt-search-" + Oe),
                  Oe++,
                  (u = function (t) {
                      var e = this.value;
            ...
            function (t, e) {
                ...
                function n() {
                    !(function t(e, n, a) {
                        ...
                        var r = a.type ? V.ext.pager[a.type] : Re,
                        ...
                        for (var p = 0; p < f.length; p++) {
                            ...
                            H(v.clicker).attr({
                                ...
                                "aria-label": b,
                                "data-dt-idx": g,
                                tabIndex: m.disabled ? -1 : e.iTabIndex || null,
                            }),
                                "number" != typeof g &&
                                    H(v.clicker).addClass(g),
                                ee(v.clicker, { action: g }, function (t) {
                                    t.preventDefault(),
