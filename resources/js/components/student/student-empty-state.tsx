...
export function StudentEmptyState({ title, description }: StudentEmptyStateProps) {
    return (
        <div className="rounded-[28px] border border-dashed border-orange-200 bg-orange-50/70 p-10 text-center shadow-[0_18px_34px_-30px_color-mix(in_srgb,var(--site-primary-color)_50%,transparent)]">
