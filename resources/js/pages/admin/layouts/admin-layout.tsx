...
const navSections: NavSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                title: 'تسليمات المهام',
                href: '/admin/task-submissions',
                icon: BookOpenCheck,
            },
            {
                title: 'تقدم الدروس',
                href: '/admin/lesson-progress',
                icon: BookOpenCheck,
            },
        ],
    },
    ...
    },
    {
        ...
        items: [
            { title: 'الإعدادات', href: '/admin/settings', icon: Settings },
            {
                ...
                href: '/admin/settings?group=mail',
                icon: Mail,
            },
            { title: 'التكاملات', href: '/admin/integrations', icon: CodeXml },
...
export default function AdminLayout({ title, children }: AdminLayoutProps) {
    ...
    const primaryColor =
        page.props.settings?.primary_color?.trim() ||
        'var(--site-primary-color)';
    const shellStyle = {
        ['--admin-brand' as '--admin-brand']: primaryColor,
    } as CSSProperties;
        ...
        <>
            ...
            >
                <div className="flex min-h-screen flex-col overflow-x-hidden lg:flex-row">
                    <aside
                        className={`fixed inset-y-0 right-0 z-50 flex w-full max-w-[308px] flex-col border-l border-white/20 bg-[linear-gradient(180deg,#141b2d_0%,#10223b_42%,#0f172a_100%)] px-4 py-4 text-white shadow-2xl transition-transform duration-300 sm:px-5 sm:py-5 lg:static lg:translate-x-0 ${
                    ...
                    >
                        <div className="flex items-center justify-between rounded-3xl border border-white/10 bg-white/5 px-4 py-4">
                            <div className="flex items-center gap-3">
                                <div
                                    ...
                                    style={{
                                        background: `linear-gradient(135deg, ${primaryColor}, var(--site-primary-400))`,
                                    }}
                                >
                                    KC
                                </div>
                        ...
                        <div
                            ref={navScrollRef}
                            className="mt-5 flex-1 space-y-5 overflow-y-auto overscroll-contain pr-1 pl-1"
                        >
                    ...
                    <main className="flex-1 px-3 py-4 sm:px-6 lg:px-8 lg:py-6">
                        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between lg:hidden">
                            <button
                                type="button"
                                onClick={() => setMobileOpen(true)}
                                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-orange-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm"
                            >
                                <Menu size={18} />
                                القائمة
                            </button>
                            <Link
                                href="/"
                                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-orange-200/80 bg-orange-50 px-4 py-2.5 text-sm font-semibold text-orange-700"
                            >
                                <Rocket size={16} />
                                عرض الموقع
                            </Link>
                        ...
                        <div className="rounded-[28px] border border-white/70 bg-white/85 p-4 shadow-[0_20px_50px_rgba(15,23,42,0.08)] backdrop-blur sm:p-5">
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                                <div className="text-right">
                                    ...
                                    <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-500">
                                        إدارة المحتوى والكورسات والإعدادات من
                                        مساحة موحدة ومهيأة بالكامل للعرض العربي.
                                    </p>
                                </div>
                                <div className="grid w-full gap-3 text-right sm:w-auto sm:min-w-[240px]">
                                    <div className="rounded-2xl border border-orange-100 bg-orange-50 px-4 py-3">
                                        <div className="text-xs font-semibold text-orange-600">
                                            الاتجاه
                                        </div>
                                        <div className="mt-1 text-sm font-bold text-slate-800">
                                            RTL مفعل على الواجهة
                                        </div>
                                    </div>
