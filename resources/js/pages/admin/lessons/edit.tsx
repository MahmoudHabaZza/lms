            ...
            <div className="mx-auto w-full max-w-6xl space-y-5">
                <div className="flex items-center justify-between">
                    <div className="text-right">
                        ...
                        <p className="mt-1 text-sm text-slate-500">راجع عنوان الدرس والوصف ورابط الفيديو وترتيب الظهور قبل الحفظ.</p>
                    </div>
                ...
                <LessonForm data={data} setData={setData} errors={errors} courses={courses} processing={processing} onSubmit={onSubmit} submitLabel="حفظ التعديلات" />
            </div>
        </AdminLayout>
    );
}
